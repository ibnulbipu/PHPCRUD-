	...
	<div class="container">
		...
		<div class="well" style="margin:auto; padding:auto; width:80%;">
			<span style="font-size:25px; color:blue">
				<center><strong>Employee Infromation Table</strong></center>
			</span>
			<span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New</a></span>
		<span>	<button style="float: right;background-color:aquamarine;"onclick="window.print()">Print this page</button></span>
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					?>
						<tr>
							<td><?php echo ucwords($row['em_name']); ?></td>
							<td><?php echo ($row['em_email']); ?></td>
							<td><?php echo $row['contact_no']; ?></td>
							<td><?php echo ucwords($row['em_designation']); ?></td>
							<td>
